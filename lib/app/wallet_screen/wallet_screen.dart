...
class WalletScreen extends StatelessWidget {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                (Constant.isDriverVerification == true && controller.userModel.value.isDocumentVerify == false)
                                    ? const SizedBox()
                                    : Padding(
                                ...
                                child: TabBarView(
                                  children: [
                                    ...
                                    controller.withdrawalList.isEmpty
                                        ? Constant.showEmptyView(message: "Withdrawal history not found".tr)
                                        : Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
                                            child: Container(
                                              decoration: ShapeDecoration(
  ...
  //                                 Expanded(
  //                                   child: Text(
  //                                     walletTractionModel.isFreeDelivery == true ? "Delivery charge paid by admin".tr : "Delivery charge paid by customer".tr,
  //                                     style: TextStyle(
  //                                       fontSize: 16,
  //                                       fontFamily: AppThemeData.semiBold,
  //                                       fontWeight: FontWeight.w600,
